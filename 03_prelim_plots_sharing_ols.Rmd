...
test <- fepois(incidence ~ i(year, twokm, ref = '2008-01-01') +urban_area+ mean_precip + mean_temp | cluster + year, vcov = "cluster", data = incidence_data_yearly, weights=~population)
...
ggsave("~/Desktop/doctorate/ch2 mdd highway/presentation_figures/S2_leish.pdf", fivekm_yearly_leish, width = 10, height = 6, units = c("in"), device="pdf")
...
test <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + mean_precip + mean_temp + urban_area | cluster + year, vcov = "twoway", data = incidence_data_yearly, weights=~population)
#test <- feols(incidence ~ i(year, tenkm, ref = '2008-01-01') | cluster + year, vcov = "cluster", data = incidence_data_yearly)
#test <- feols(incidence ~ i(year, tenkm, ref = '2008-01-01') | cluster + year, data = incidence_data_yearly)
#summary(test)
#class(test)
...
#build models
test_wpm <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = incidence_data_yearly, weights=~population)
test_wopm <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = incidence_data_yearly_no_pm, weights=~population)
...
# run models
test1km <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = incidence_data_yearly, weights=~population)
test1_5_buffer <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = incidence_data_yearly_buffered_13, weights=~population)
test1_10_buffer <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = incidence_data_yearly_buffered_14, weights=~population)
test1_20_buffer <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = incidence_data_yearly_buffered_15, weights=~population)
test1_30_buffer <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = incidence_data_yearly_buffered_16, weights=~population)
test1_40_buffer <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = incidence_data_yearly_buffered_10, weights=~population)
#test <- feols(incidence ~ i(year, tenkm, ref = '2008-01-01') | cluster + year, vcov = "cluster", data = incidence_data_yearly)
#test <- feols(incidence ~ i(year, tenkm, ref = '2008-01-01') | cluster + year, data = incidence_data_yearly)
#summary(test)
#class(test)
