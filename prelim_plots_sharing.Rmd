...
fig1a <- ggplot() +
  ...
  scale_fill_manual(name= "Cutoffs", values=c("0" = "#fffffc", "1" = "#ffcccc", "2" = "#41b6c4", "3" = "#225ea8"),
...
#### 5km boundary (little variation between cutpoints). Vertical line at 2008. WorldPop population data.
...
#### Yearly dengue incidence w 5km boundary, standard errors clustered at district & yearly levels. Unit and year fixed effects. Baseline year is 2008 (year before hypothesized "shock"). Puerto Maldonado included. WorldPop population data.
...
#### Yearly dengue incidence w 5km boundary, standard errors clustered at district & yearly levels. Unit and year fixed effects. Baseline year is 2008 (year before hypothesized "shock"). Puerto Maldonado included. WorldPop population data adjusted to incorporate DIRESA population data magnitudes (worldpop used to create relative values for years missing DIRESA data).
...
#### Quarterly dengue incidence w 5km boundary, standard errors clustered at district & quarterly levels. Unit and quarter fixed effects. Baseline year is 2008 (year before hypothesized "shock"). Puerto Maldonado included. WorldPop population data.
...
#### Quarterly dengue incidence w 5km boundary, standard errors clustered at district & quarterly levels. Unit and year quarter effects. Baseline year is 2008 (year before hypothesized "shock"). Puerto Maldonado included. WorldPop population data adjusted to incorporate DIRESA population data magnitudes (worldpop used to create relative values for years missing DIRESA data).
...
#### Yearly leishmaniasis incidence w 5km boundary, standard errors clustered at district & yearly levels. Unit and year fixed effects. Baseline year is 2008 (year before hypothesized "shock"). Puerto Maldonado included. WorldPop population data.
...
#### Yearly leishmaniasis incidence w 5km boundary, standard errors clustered at district & yearly levels. Unit and year fixed effects. Baseline year is 2008 (year before hypothesized "shock"). Puerto Maldonado included. WorldPop population data adjusted to incorporate DIRESA population data magnitudes (worldpop used to create relative values for years missing DIRESA data).
...
```{r}
incidence_data <- read.csv("~/Desktop/doctorate/ch2 mdd highway/data/quarterly_leish_incidence_data.csv")
...
#### Quarterly leishmaniasis incidence w 5km boundary, standard errors clustered at district & quarterly levels. Unit and quarter fixed effects. Baseline year is 2008 (year before hypothesized "shock"). Puerto Maldonado included. WorldPop population data.
...
#### Quarterly leishmaniasis incidence w 5km boundary, standard errors clustered at district & quarterly levels. Unit and year quarter effects. Baseline year is 2008 (year before hypothesized "shock"). Puerto Maldonado included. WorldPop population data adjusted to incorporate DIRESA population data magnitudes (worldpop used to create relative values for years missing DIRESA data).
...
dengue_yearly_did_popadj + ggtitle("Dengue yearly (pop adjusted)")
leish_yearly_did_popadj + ggtitle("Leish yearly (pop adjusted)")

dengue_quarterly_did + ggtitle("Dengue quarterly (worldpop)")
leish_quarterly_did + ggtitle("Leish quarterly (worldpop)")

dengue_quarterly_did_popadj + ggtitle("Dengue quarterly (pop adjusted)")
leish_quarterly_did_popadj + ggtitle("Leish quarterly (pop adjusted)")
```