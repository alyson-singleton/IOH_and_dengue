...
## Preliminary diff-in-diff results (yearly dengue model)
...
test <- feols(incidence ~ i(biannual_date, fivekm, ref = '2008-04-01') | cluster + biannual_date, vcov = "twoway", data = incidence_data_yearly)
#test <- feols(incidence ~ i(year, tenkm, ref = '2008-01-01') | cluster + year, vcov = "cluster", data = incidence_data_yearly)
#test <- feols(incidence ~ i(year, tenkm, ref = '2008-01-01') | cluster + year, data = incidence_data_yearly)
#summary(test)
#class(test)
...
## Preliminary diff-in-diff results (yearly leish model)
