...
### yearly model
dengue_yearly_model <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly, weights=~population)
...
### yearly leish model
leish_yearly_model <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + mean_precip + mean_temp + urban_area | cluster + year, vcov = "cluster", data = leish_df_yearly, weights=~population)
...
### biannual model
leish_biannual_model <- fepois(incidence ~ i(biannual_date, onekm, ref = '2008-04-01') + mean_precip + mean_temp + urban_area | cluster + biannual_date, vcov = "cluster", data = leish_df_biannual, weights=~population)
