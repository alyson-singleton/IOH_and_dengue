...
## STable S2
#####################
stable2 <- etable(dengue_yearly_model_main_agg,dengue_yearly_model_no_PM_agg,
                  dengue_yearly_model_pop_weight_agg,dengue_yearly_model_onekm_agg,
                  dengue_yearly_model_tenkm_agg,dengue_yearly_model_no_buffer_agg,
                  dengue_yearly_model_buffer_bigger_agg,dengue_yearly_model_confirmed_agg, 
                  dengue_yearly_model_prepost_agg, 
                  digits = 3,
                  signif.code = c("*" = 0.05))
...
sfig3_df$estimate <- as.numeric(df$estimate)
...
sfig3_df$Model <- factor(as.character(sfig3_df$Model), levels=c('No PM', 'Pop weight','1km','10km','No buffer', 'Big buffer', 'Conf & prob cases', "Pre post", 'Main'))
...
sfig3 <- ggplot(sfig3_df, aes(group=Model)) +
  ...
  scale_color_manual(name = "Model specification", values=list('No PM'='#DC267F','Pop weight'="#FE6100",'1km'='#FFB000','10km'='#FFE518','No buffer'='#85CE76', 'Big buffer'='#126E29','Conf & prob cases'="#648FFF", 'Main' = "#2b175e"),
                     labels=list('No PM', 'Pop weight','1km boundary','10km boundary','No buffer (<5km v >5km)', 'Large buffer (<5km v >20km)', 'Conf & prob cases', 'Main model'))+
  scale_fill_manual(name = "Model specification", values=list('No PM'='#DC267F','Pop weight'="#FE6100",'1km'='#FFB000','10km'='#FFE518','No buffer'='#85CE76', 'Big buffer'='#126E29','Conf & prob cases'="#648FFF", 'Main' = '#2b175e'),
                    labels=list('No PM', 'Pop weight','1km boundary','10km boundary','No buffer (<5km v >5km)', 'Large buffer (<5km v >20km)', 'Conf & prob cases', 'Main model'))+
