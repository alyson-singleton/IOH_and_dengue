...
stable1[33,] <- c(rep(length(unique(dengue_yearly$connected_buffered$cluster)),2))
stable1[9,] <- c("----","----")
...
#consider updating this so the main model is just bold black outline with no fill in the point estimate
