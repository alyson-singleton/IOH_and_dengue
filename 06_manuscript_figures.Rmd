...
table1[13,] <- c(rep(65,6))#need to update this
...
rownames(table1) <- c("Urban", "Ag", "Sum Precip", "Mean Temp", "5km x Post-2008 Yearly", "5km x Post-2008 Biannual", "FEs", "Cluster", "Year", "Biannual", "R^2", "N", "Clusters")
