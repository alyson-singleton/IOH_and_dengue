...
center_lat_long_fig1$all_cutoffs <- factor(center_lat_long_fig1$all_cutoffs, levels=c('0','1','3'))
...
mdd_map <- ggplot() +
              ...
              scale_fill_manual(name= "", values=c("0" = "#648FFF", "1" = "#E04490", "3" = "#ffffff"), #41b6c4 #fccccc
