...
### yearly model
dengue_yearly_model <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly, weights=~population)
...
dengue_yearly_model_1km <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_5km <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_10km <- fepois(incidence ~ i(year, tenkm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly, weights=~population)
#summary(test1km)
...
dengue_yearly_model_5km <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_10km <- fepois(incidence ~ i(year, tenkm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_20km <- fepois(incidence ~ i(year, twentykm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_30km <- fepois(incidence ~ i(year, thirtykm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_40km <- fepois(incidence ~ i(year, fortykm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly, weights=~population)
...
dengue_yearly_model_unweighted <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly)
dengue_yearly_model_weighted <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly, weights=~population)

df <- rbind(
  as.data.frame(cbind(dengue_yearly_model_unweighted$coeftable[1:19,],c(rep("No weighting",19)))),
  as.data.frame(cbind(dengue_yearly_model_weighted$coeftable[1:19,],c(rep("Pop weighting",19)))))
...
```{r, pm sensitivity}
dengue_yearly_model_wpm <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_wopm <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly_no_pm, weights=~population)
...
dengue_yearly_model_2008 <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly)
dengue_yearly_model_2007 <- fepois(incidence ~ i(year, fivekm, ref = '2007-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly)
dengue_yearly_model_2006 <- fepois(incidence ~ i(year, fivekm, ref = '2006-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly)
#summary(test)
...
dengue_yearly_model_2009 <- fepois(incidence ~ i(year, fivekm, ref = '2009-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly)
dengue_yearly_model_2008 <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly)
dengue_yearly_model_2007 <- fepois(incidence ~ i(year, fivekm, ref = '2007-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly)
dengue_yearly_model_2006 <- fepois(incidence ~ i(year, fivekm, ref = '2006-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly)
...
#build models
dengue_yearly_model_baseline <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly)
dengue_yearly_model_permuted <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly_permuted)
...
# run models
dengue_yearly_model_1km <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_1_5_buffer <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly_buffered_13, weights=~population)
dengue_yearly_model_1_10_buffer <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly_buffered_14, weights=~population)
dengue_yearly_model_1_20_buffer <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly_buffered_15, weights=~population)
dengue_yearly_model_1_30_buffer <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly_buffered_16, weights=~population)
dengue_yearly_model_1_40_buffer <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "cluster", data = dengue_df_yearly_buffered_10, weights=~population)
