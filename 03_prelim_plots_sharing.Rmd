...
### yearly model
dengue_yearly_model <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered)
...
df$upper <- df$estimate+(1.96*(exp(df$std_error)-1))
df$lower <- df$estimate-(1.96*(exp(df$std_error)-1))
...
```{r, magnitude of impact calculations ols, eval=F}
#mean
...
### biannual model
dengue_biannual_model <- fepois(incidence ~ i(biannual_date, fivekm, ref = '2008-04-01') + mean_precip + mean_temp + log(urban) + log(ag) | cluster + biannual_date, vcov = "twoway", data = dengue_df_biannual_buffered)
...
### yearly leish model
leish_yearly_model <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + mean_precip + mean_temp + log(urban) + log(ag) | cluster + year, vcov = "twoway", data = leish_df_yearly_buffered)
...
### biannual model
leish_biannual_model <- fepois(incidence ~ i(biannual_date, fivekm, ref = '2008-04-01') + mean_precip + mean_temp + log(urban) + log(ag) | cluster + biannual_date, vcov = "twoway", data = leish_df_biannual_buffered)
...
dengue_yearly_model_linear_urban <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered)
dengue_yearly_model_log_urban <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered)
...
leish_yearly_model_wo_ag <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = leish_df_yearly_buffered)
leish_yearly_model_w_ag <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = leish_df_yearly_buffered)
...
dengue_yearly_model_1km <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly)
dengue_yearly_model_5km <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly)
dengue_yearly_model_10km <- fepois(incidence ~ i(year, tenkm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly)
#summary(test1km)
...
dengue_yearly_model_1km <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_5km <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_10km <- fepois(incidence ~ i(year, tenkm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_20km <- fepois(incidence ~ i(year, twentykm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_30km <- fepois(incidence ~ i(year, thirtykm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_40km <- fepois(incidence ~ i(year, fortykm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
...
dengue_yearly_model_unweighted <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered)
dengue_yearly_model_weighted <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered, weights=~population)
...
leish_yearly_model_unweighted <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = leish_df_yearly_buffered)
leish_yearly_model_weighted <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = leish_df_yearly_buffered, weights=~population)
...
```{r, pm sensitivity}
dengue_yearly_model_wpm <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered)
dengue_yearly_model_wopm <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered_no_pm)
...
dengue_yearly_model_2008 <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered)
dengue_yearly_model_2007 <- fepois(incidence ~ i(year, fivekm, ref = '2007-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered)
dengue_yearly_model_2006 <- fepois(incidence ~ i(year, fivekm, ref = '2006-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered)
#summary(test)
...
dengue_yearly_model_2009 <- fepois(incidence ~ i(year, fivekm, ref = '2009-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_2008 <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_2007 <- fepois(incidence ~ i(year, fivekm, ref = '2007-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_2006 <- fepois(incidence ~ i(year, fivekm, ref = '2006-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
...
#build models
dengue_yearly_model_baseline <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered)
dengue_yearly_model_permuted <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_permuted)
...
# run models
dengue_yearly_model_5km <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly)
dengue_yearly_model_5_10_buffer <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered_24)
dengue_yearly_model_5_20_buffer <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered_25)
dengue_yearly_model_5_30_buffer <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered_26)
dengue_yearly_model_5_40_buffer <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban) + log(ag) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered_20)
