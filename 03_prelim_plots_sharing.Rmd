...
#fix road buffers colnames
colnames(dengue_df_yearly)[5:13] <- c("onekm", "twokm","threekm", "fourkm", "fivekm", "tenkm", "twentykm", "thirtykm", "fortykm")
...
for(i in 1:dim(dengue_df_yearly)[1]){
  dengue_df_yearly$all_cutoffs[i] <- ifelse(dengue_df_yearly$onekm[i]==1, 1, 0)
  dengue_df_yearly$all_cutoffs[i] <- ifelse(dengue_df_yearly$fivekm[i]==1&&dengue_df_yearly$onekm[i]==0, 2, 
                                            dengue_df_yearly$all_cutoffs[i])
  dengue_df_yearly$all_cutoffs[i] <- ifelse(dengue_df_yearly$tenkm[i]==1&&dengue_df_yearly$fivekm[i]==0&&
                                              dengue_df_yearly$onekm[i]==0, 3, dengue_df_yearly$all_cutoffs[i])
  dengue_df_yearly$all_cutoffs[i] <- ifelse(dengue_df_yearly$twentykm[i]==1&&dengue_df_yearly$tenkm[i]==0&&
                                              dengue_df_yearly$fivekm[i]==0&&dengue_df_yearly$onekm[i]==0, 4, 
                                            dengue_df_yearly$all_cutoffs[i])
  dengue_df_yearly$all_cutoffs[i] <- ifelse(dengue_df_yearly$thirtykm[i]==1&&dengue_df_yearly$twentykm[i]==0&&
                                              dengue_df_yearly$tenkm[i]==0&&dengue_df_yearly$fivekm[i]==0&&
                                              dengue_df_yearly$onekm[i]==0, 5, dengue_df_yearly$all_cutoffs[i])
  dengue_df_yearly$all_cutoffs[i] <- ifelse(dengue_df_yearly$fortykm[i]==1&&dengue_df_yearly$thirtykm[i]==0&&
                                              dengue_df_yearly$twentykm[i]==0&&dengue_df_yearly$tenkm[i]==0&&
                                              dengue_df_yearly$fivekm[i]==0&&dengue_df_yearly$onekm[i]==0, 6, 
                                            dengue_df_yearly$all_cutoffs[i])
}
# build easily accessible buffer datasets for each buffer option
# build treatment dummy where below 5km is 1, between 5km and 10km are thrown out, and above 10km is 0
...
#fix road buffers colnames
colnames(leish_df_yearly)[5:13] <- c("onekm", "twokm","threekm", "fourkm", "fivekm", "tenkm", "twentykm", "thirtykm", "fortykm")
...
### yearly model
dengue_yearly_model <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
...
#fix road buffers colnames
colnames(dengue_df_biannual)[5:13] <- c("onekm", "twokm","threekm", "fourkm", "fivekm", "tenkm", "twentykm", "thirtykm", "fortykm")
...
dengue_df_biannual_no_pm <- dengue_df_biannual_no_pm[complete.cases(dengue_df_biannual_no_pm),]
...
#fix road buffers colnames
colnames(leish_df_biannual)[5:13] <- c("onekm", "twokm","threekm", "fourkm", "fivekm", "tenkm", "twentykm", "thirtykm", "fortykm")
...
#remove PM
leish_df_yearly_no_pm <- leish_df_biannual[!(leish_df_biannual$cluster %in% 1),]
leish_df_yearly_no_pm <- leish_df_biannual[complete.cases(leish_df_yearly_no_pm),]
...
### yearly leish model
leish_yearly_model <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + mean_precip + mean_temp + log(urban_area) | cluster + year, vcov = "twoway", data = leish_df_yearly, weights=~population)
...
# run models
dengue_yearly_model_5km <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly)
dengue_yearly_model_5_20_buffer <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered_24)
dengue_yearly_model_5_30_buffer <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered_25)
dengue_yearly_model_5_40_buffer <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered_26)
dengue_yearly_model_5_gt40_buffer <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered_20)
