...
fig1a <- ggplot() +
  ...
  scale_fill_manual(name= "Legend", values=c("0" = "white", "2" = "#fccccc", "3" = "#225ea8"), #41b6c4 #fccccc
                    labels=c("Control (>5km)", "Treated (<5km)", "Buffer (removed)")) +
  theme_minimal() +
  no_axis +
...
# urban area + 0.001 so 0's dont go to infinity when logged
...
### yearly model
dengue_yearly_model <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered_no_pm)
...
### biannual model
dengue_biannual_model <- fepois(incidence ~ i(biannual_date, fivekm, ref = '2009-04-01') + mean_precip + mean_temp + log(urban_area) | cluster + biannual_date, vcov = "twoway", data = dengue_df_biannual, weights=~population)
#summary(dengue_biannual_model)

df <- as.data.frame(dengue_biannual_model$coeftable)
df <- df[1:45,]
colnames(df) <- c('estimate', 'std_error', 't_value', 'p_value')
df$biannual_date <- as.Date(c(unique(dengue_df_biannual$biannual_date)[c(1:18,20:46)]))
df$rainy <- 0
df$rainy[c(seq(1, 46, 2))] <- 1
...
dengue_biannual_did_popadj <- ggplot(df) +
  ...
  geom_vline(aes(xintercept=as.Date("2009-04-01")), linetype='dashed', size=0.4) +
  geom_point(aes(x=as.Date("2009-04-01"), y=0), size=3, shape=21, fill='white') +
...
### yearly leish model
leish_yearly_model <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + mean_precip + mean_temp + log(urban_area) | cluster + year, vcov = "twoway", data = leish_df_yearly_buffered)
...
### biannual model
leish_biannual_model <- fepois(incidence ~ i(biannual_date, fivekm, ref = '2008-04-01') + mean_precip + mean_temp + log(urban_area) | cluster + biannual_date, vcov = "twoway", data = leish_df_biannual, weights=~population)
...
dengue_yearly_model_linear_urban <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + urban_area + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_log_urban <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)

df <- rbind(
  as.data.frame(cbind(dengue_yearly_model_linear_urban$coeftable[1:22,],c(rep("Linear urban",22)))),
  as.data.frame(cbind(dengue_yearly_model_log_urban$coeftable[1:22,],c(rep("Log urban",22)))))
...
dengue_yearly_model_1km <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_5km <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_10km <- fepois(incidence ~ i(year, tenkm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
#summary(test1km)
...
dengue_yearly_model_5km <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_10km <- fepois(incidence ~ i(year, tenkm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_20km <- fepois(incidence ~ i(year, twentykm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_30km <- fepois(incidence ~ i(year, thirtykm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_40km <- fepois(incidence ~ i(year, fortykm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
...
dengue_yearly_model_unweighted <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly)
dengue_yearly_model_weighted <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
...
leish_yearly_model_unweighted <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = leish_df_yearly)
leish_yearly_model_weighted <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = leish_df_yearly, weights=~population)
...
dengue_yearly_model_wpm <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_wopm <- fepois(incidence ~ i(year, onekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_no_pm, weights=~population)
...
dengue_yearly_model_wpm <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_wopm <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_no_pm, weights=~population)
...
dengue_yearly_model_2008 <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_2007 <- fepois(incidence ~ i(year, fivekm, ref = '2007-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_2006 <- fepois(incidence ~ i(year, fivekm, ref = '2006-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
#summary(test)
...
dengue_yearly_model_2009 <- fepois(incidence ~ i(year, fivekm, ref = '2009-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_2008 <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_2007 <- fepois(incidence ~ i(year, fivekm, ref = '2007-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_2006 <- fepois(incidence ~ i(year, fivekm, ref = '2006-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
...
#permute treatment dummy
set.seed(98)
dengue_df_yearly_permuted  <- transform(dengue_df_yearly, fivekm = sample(fivekm))   
#repeat for 1000 draws
#for(i in 1:100){
#}

#build models
dengue_yearly_model_baseline <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_permuted <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_permuted, weights=~population)
...
# run models
dengue_yearly_model_5km <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly, weights=~population)
dengue_yearly_model_5_20_buffer <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered_24, weights=~population)
dengue_yearly_model_5_30_buffer <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered_25, weights=~population)
dengue_yearly_model_5_40_buffer <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered_26, weights=~population)
dengue_yearly_model_5_gt40_buffer <- fepois(incidence ~ i(year, fivekm, ref = '2008-01-01') + log(urban_area) + mean_precip + mean_temp | cluster + year, vcov = "twoway", data = dengue_df_yearly_buffered_20, weights=~population)
...
df <- rbind(
  ...
  as.data.frame(cbind(dengue_yearly_model_5_gt40_buffer$coeftable[1:22,],c(rep("40kmplus_buffered",22)))))
...
df$upper <- df$estimate+1.96*df$std_error
df$lower <- df$estimate-1.96*df$std_error
df$Cutoff <- factor(as.character(df$Cutoff), levels=c('5km','20km_buffered','30km_buffered','40km_buffered','40kmplus_buffered'))
dengue_yearly_did_popadj_buffer_sens <- ggplot(df, aes(group=Cutoff)) +
  ...
  geom_point(aes(x=as.Date("2008-01-01"), y=0), size=3, shape=21, fill='white') +
  geom_point(aes(year, estimate, fill=Cutoff), color='black',position = position_dodge(width=250), size=3, shape=21) +
  scale_color_manual(name="Treament, control", values=list('5km'="#648FFF",'20km_buffered'='#DC267F',
                                                   '30km_buffered'='#FFB000','40km_buffered'='#FFE518','40kmplus_buffered'='purple4'), 
                     labels=list("5km"="<5km, >5km", "20km_buffered"="<5km, >10km", 
                                 "30km_buffered"="<5km, >20km", "40km_buffered"="<5km, >30km", "40kmplus_buffered"="<5km, >40km"))+
  scale_fill_manual(name="Treament, control", values=list('5km'="#648FFF",'20km_buffered'='#DC267F',
                                                   '30km_buffered'='#FFB000','40km_buffered'='#FFE518','40kmplus_buffered'='purple4'), 
                     labels=list("5km"="<5km, >5km", "20km_buffered"="<5km, >10km", 
                                 "30km_buffered"="<5km, >20km", "40km_buffered"="<5km, >30km", "40kmplus_buffered"="<5km, >40km"))+
  xlab("Year") + ylab("log(yearly\ndengue incidence\nrate ratio)") + 
