...
dengue_yearly_did_popadj <- ggplot(df) +
  geom_hline(aes(yintercept=1), colour='red', linewidth=.4) +
  ...
  geom_point(aes(x=as.Date("2008-01-01"), y=1), size=3, shape=21, fill='white') +
  geom_point(aes(year, estimate), size=3, shape=21, fill='white') +
  xlab("Year") + ylab("Percent\nchange\ndengue\nincidence") + 
  theme_bw()+
  #scale_y_continuous(labels = scales::percent, limits=c(-1,5.5)) +
